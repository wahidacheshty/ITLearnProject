...
import com.aventstack.extentreports.ExtentReports;//attach the test
...
public class ITestListenerClass extends Base  implements ITestListener {
	...
	public void configureReport()
	{
		...
		reports.setSystemInfo("Machine", "Wahida Pc");
	...
	public void onTestStart(ITestResult result) {
	  ...
	  System.out.println("Name of the test method successfully excuted "+result.getName());
	   ...
	   test.log(Status.PASS, MarkupHelper.createLabel("Name of the start test case is: "+result.getName(),ExtentColor.GREEN));
	  }
	  ...
	  public void onTestFailure(ITestResult result) {
	    ...
	    test.log(Status.FAIL, MarkupHelper.createLabel("Name of the failure test case is: "+result.getName(),ExtentColor.RED));
